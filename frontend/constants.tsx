...
export const MOCK_WORKSPACES: Workspace[] = [
  {
    ...
    branch: "main",
    commit: "f29a1d4",
    repositoryId: "trackcodex-backend",
    collaborators: [
  ...
  },
  {
    ...
    branch: "develop",
    commit: "a1b2c3d",
    repositoryId: "dashboard-ui",
    collaborators: ["https://picsum.photos/seed/3/32"],
  },
  {
    id: "incomplete-task",
    name: "auth-refactor-stub",
    status: "Failed",
    runtime: "Python 3.11",
    lastModified: "2h ago",
    repo: "trackcodex/auth-service",
    branch: "feature/refactor",
    commit: "b9e2f1a",
    repositoryId: "auth-service",
    collaborators: ["https://picsum.photos/seed/4/32"],
  },
  {
    id: "empty-shell",
    name: "new-microservice-base",
    status: "Cloning",
    runtime: "Go 1.21",
    lastModified: "10m ago",
    repo: "trackcodex/platform-base",
    branch: "main",
    commit: "e8f7d6c",
    repositoryId: "platform-base",
    collaborators: ["https://picsum.photos/seed/5/32"],
  },
];
