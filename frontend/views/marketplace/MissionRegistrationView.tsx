...
const InputField = ({ 
  ...
  <div className="flex-1 min-w-[300px]">
    <label htmlFor={name} className="block text-[13px] font-bold text-gh-text-secondary mb-2">
      {label}{required && <span className="text-red-500 ml-1">*</span>}
    </label>
    <div className="relative">
      {icon && (
        onIconClick ? (
          <button 
            type="button"
            className={`absolute left-3 top-1/2 -translate-y-1/2 text-gh-text-secondary cursor-pointer hover:text-blue-500 transition-colors border-none bg-transparent p-0 flex items-center justify-center`}
            onClick={() => onIconClick()}
          ...
          <div className="absolute left-3 top-1/2 -translate-y-1/2 text-gh-text-secondary pointer-events-none">
            {icon}
          </div>
        )
      )}
...
const MissionRegistrationView = () => {
  ...
  if (!mission) return <div className="p-8 text-center text-gh-text-secondary bg-gh-bg min-h-screen">Loading mission details...</div>;
          ...
          <div id="basic-details" className="scroll-mt-20">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-6">
                ...
                />
                <div className="flex-1 min-w-[300px]">
                    <label htmlFor="mobile-input" className="block text-[13px] font-bold text-gh-text-secondary mb-2">
                    ...
                    <div className="flex gap-2">
                        ...
                        <div className="relative flex-1">
                            ...
                            />
                            <button type="button" aria-label="Verify mobile number" className="absolute right-2 top-1/2 -translate-y-1/2 text-[11px] font-bold text-blue-600 px-3 py-1 hover:bg-blue-500/10 rounded">Verify</button>
                        </div>
                    </div>
                </div>
              </div>
              ...
              <div className="w-full bg-gh-bg border border-gh-border rounded-[32px] shadow-sm mb-6">
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-2">
                    <button className="flex items-center justify-center w-11 h-11 rounded-xl bg-gh-bg-tertiary text-gh-text-secondary hover:text-gh-text border border-gh-border">
                      <span className="material-symbols-outlined text-[18px]">north_east</span>
                    </button>
                    <button className="flex-1 flex items-center justify-center gap-2 h-11 rounded-xl bg-gh-bg-tertiary text-gh-text font-bold text-[13px] border border-gh-border">
