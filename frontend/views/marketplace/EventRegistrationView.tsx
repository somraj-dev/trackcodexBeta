...
const EventRegistrationView = () => {
  ...
  const [mission, setMission] = useState<any>({
    id: id || "ev-1",
    title: id === "ev-2" ? "ISCMCTR-2026" : "Fortune'26 The Finance Fiesta",
    creator: {
      name: id === "ev-2" ? "MITS Gwalior" : "Delhi Technological University",
      avatar: ""
    },
    metadata: {
      minTeamSize: id === "ev-2" ? "1" : "1",
      maxTeamSize: id === "ev-2" ? "1" : "4",
      participationType: id === "ev-2" ? "Individual Participation" : "Team Participation"
    }
  });
