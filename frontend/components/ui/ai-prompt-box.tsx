...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 z-10 rounded-full bg-[#2E3033]/80 p-2 hover:bg-[#2E3033] transition-all" aria-label="Close dialog">
...
export const PromptInputBox = React.forwardRef((props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
  ...
  const handleHandToggle = () => setShowHand((prev) => !prev);
          ...
          >
            ...
            <div className="flex items-center">
              ...
              <button
                ...
                aria-label="Toggle think deeply"
              >
                <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                  <motion.div
              ...
              >
                <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                  <motion.div
                    animate={{ rotate: showHand ? 360 : 0, scale: showHand ? 1.1 : 1 }}
                    whileHover={{ rotate: showHand ? 360 : 15, scale: 1.1, transition: { type: "spring", stiffness: 300, damping: 10 } }}
                    transition={{ type: "spring", stiffness: 260, damping: 25 }}
                  >
                    <FolderCode className={cn("w-4 h-4", showHand ? "text-[#F97316]" : "text-inherit")} />
                  </motion.div>
                </div>
                <AnimatePresence>
                  {showHand && (
