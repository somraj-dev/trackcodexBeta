    ...
    <div className="font-display relative text-gh-text">
      ...
      {isSelf ? (
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <button
            onClick={handleOffer}
            className="px-4 py-1.5 whitespace-nowrap bg-gh-bg-secondary text-gh-text border border-gh-border rounded-md text-sm font-bold hover:border-primary/50 transition-all hover:text-primary"
          >
            Job Offer
          </button>
          <button
