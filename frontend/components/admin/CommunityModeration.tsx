    ...
    <div className="animate-in fade-in duration-500">
      <div className="flex items-center justify-between mb-10">
        ...
        <div className="flex items-center gap-3">
          <button className="bg-primary hover:bg-blue-600 text-white px-5 py-2 rounded-xl text-xs font-medium uppercase tracking-widest transition-all flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
        <div className="xl:col-span-3 space-y-6">
          <h3 className="text-[11px] font-medium uppercase tracking-widest text-gh-text-secondary mb-4 flex items-center gap-2">
                  ...
                  >
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-2">
                        <span className="text-[10px] font-semibold px-2 py-0.5 rounded bg-gh-bg border border-gh-border text-gh-text-secondary uppercase">
                          {flag.type}
                        </span>
          ...
          <section>
            ...
            <div className="bg-gh-bg-secondary border border-gh-border rounded-2xl p-6 space-y-6">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-semibold text-gh-text">24</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs text-gh-text-secondary">
                  Auto-Resolved
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-semibold text-amber-500">4</span>
              </div>
              <div className="pt-4 border-t border-gh-border">
                <div className="flex items-center gap-2 text-[10px] font-semibold text-primary uppercase mb-4">
