    ...
    <div className="space-y-8">
      ...
      <div className="p-6 bg-[#11141A] border border-[#1E232E] rounded-2xl">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-[10px] font-medium uppercase tracking-widest text-slate-500">Top Contributors</h3>
      ...
      {/* Upcoming Events */}
      <div className="p-6 bg-[#11141A] border border-[#1E232E] rounded-2xl">
        <h3 className="text-[10px] font-medium uppercase tracking-widest text-slate-500 mb-6">Upcoming Events</h3>
          ...
          {events.map(event => (
            <div key={event.title} className="p-4 bg-[#0A0D14] border border-[#1E232E] rounded-xl flex items-center gap-4 group cursor-pointer hover:border-primary transition-all">
              <div className="size-12 bg-[#11141A] border border-[#1E232E] rounded-lg flex flex-col items-center justify-center shrink-0">
                <span className="text-[10px] font-semibold text-slate-500 uppercase leading-none mb-1">{event.date.split(' ')[0]}</span>
                <span className="text-[15px] font-semibold text-white leading-none">{event.date.split(' ')[1]}</span>
              </div>
              <div>
      ...
      <div className="p-6 bg-gradient-to-br from-[#1c2436] to-[#0d1117] border border-primary/20 rounded-2xl shadow-xl">
        <div className="flex items-center gap-2 text-primary mb-4">
           ...
           <span className="text-[11px] font-medium uppercase tracking-widest">Weekly Digest</span>
        </div>
        ...
        <button className="w-full py-2.5 bg-primary hover:bg-blue-600 text-white text-[11px] font-medium uppercase tracking-widest rounded-xl shadow-lg shadow-primary/20 transition-all">Subscribe</button>
      </div>
    </div>
  );
};
