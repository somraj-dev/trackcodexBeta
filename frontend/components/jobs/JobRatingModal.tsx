      ...
      <div className="bg-[#11141A] border border-primary/30 w-full max-w-lg rounded-3xl overflow-hidden shadow-2xl flex flex-col">
        ...
        <div className="p-8 space-y-8">
          <div className="flex flex-col items-center gap-4">
            <span className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest">Quality of Work</span>
          ...
          <div>
            <label className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest block mb-2">Detailed Feedback</label>
            <textarea 
              value={feedback}
        ...
        <div className="p-6 bg-[#0A0D14] border-t border-[#1E232E] flex items-center gap-3">
          ...
          <button 
            ...
            className="flex-1 py-3 bg-primary hover:bg-blue-600 text-white rounded-xl font-medium uppercase tracking-widest text-xs transition-all shadow-lg shadow-primary/20"
          >
            Submit & Complete
          </button>
        </div>
