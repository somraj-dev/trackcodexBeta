...
export const CreateProjectModal: React.FC<CreateProjectModalProps> = ({ isOpen, onClose, onDeploy, mode = "project" }) => {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 3000, display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      ...
      <div style={{ 
        position: "relative", width: "100%", maxWidth: 500, background: V.bg, 
        border: `1px solid ${V.border}`, borderRadius: 16, display: "flex", flexDirection: "column",
        boxShadow: "0 24px 48px rgba(0,0,0,0.5)", overflow: "hidden", fontFamily: V.font
      }}>
        <div style={{ padding: "20px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: `1px solid ${V.border}` }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ width: 32, height: 32, borderRadius: 8, background: V.bg, border: `1px solid ${V.border}`, display: "flex", alignItems: "center", justifyContent: "center", color: V.accent }}>
              {step === 1 ? (
                mode === 'task' ? (
            ...
            <h2 style={{ fontSize: 18, fontWeight: 700, margin: 0, color: V.text }}>
            ...
            <>
              <div style={{ marginBottom: 24 }}>
                ...
                <input 
                  ...
                  style={{ width: "100%", height: 44, padding: "0 14px", background: V.bg, border: `1px solid ${projectName ? V.textTertiary : V.border}`, borderRadius: 10, color: V.text, fontSize: 14, outline: "none", transition: "border-color .2s" }}
                />
              </div>
              ...
              <div style={{ display: "flex", gap: 16, marginBottom: 24 }}>
                <div style={{ flex: 1 }}>
                  ...
                  <div 
                    ...
                    style={{ height: 44, padding: "0 14px", background: V.bg, border: `1px solid ${V.border}`, borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "pointer" }}
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                      <div style={{ width: 24, height: 24, borderRadius: "50%", background: "#7C3AED", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 700, color: V.text }}>Y</div>
                      <span style={{ fontSize: 14, color: V.text }}>You</span>
                    </div>
                ...
                <div style={{ flex: 1, position: "relative" }}>
                  ...
                  <div 
                    ...
                    style={{ height: 44, padding: "0 14px", background: V.bg, border: `1px solid ${showDatePicker ? V.accent : V.border}`, borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "space-between", color: endDate ? V.text : V.textTertiary, cursor: "pointer", transition: "border-color .2s ease" }}
                  >
                  ...
                  {showDatePicker && (
                    <div style={{ position: "absolute", top: "calc(100% + 8px)", right: 0, width: 300, background: V.bg, border: `1px solid ${V.border}`, borderRadius: 12, boxShadow: "0 16px 48px rgba(0,0,0,0.7)", zIndex: 4000, overflow: "hidden" }}>
                      <div style={{ padding: "12px 16px", borderBottom: `1px solid #1A1A1A`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        ...
                        <span style={{ fontSize: 13, fontWeight: 700, color: V.text }}>{calendarMonth.toLocaleString('default', { month: 'long' })} {calendarMonth.getFullYear()}</span>
                        <button onClick={(e) => { e.stopPropagation(); setCalendarMonth(new Date(calendarMonth.getFullYear(), calendarMonth.getMonth() + 1, 1)); }} style={{ width: 28, height: 28, borderRadius: "50%", border: "none", background: "transparent", color: V.textSecondary, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18 }}>›</button>
                      </div>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 2 }}>
                          {(() => {
                            ...
                            for (let i = firstDay - 1; i >= 0; i--) {
                              days.push(<div key={`prev-${i}`} style={{ height: 32, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, color: V.textTertiary }}>{prevMonthLastDate - i}</div>);
                            }
                              ...
                              days.push(
                                <div 
                                  ...
                                  style={{ height: 32, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, borderRadius: 6, cursor: "pointer", transition: "all .2s", 
                                    ...
                                    color: isSelected ? V.bg : isToday ? V.accent : V.text
                                  }}
                                  onMouseEnter={e => !isSelected && (e.currentTarget.style.background = V.cardHover)}
                      ...
                      <div style={{ padding: "16px 24px", borderTop: `1px solid ${V.border}`, display: "flex", justifyContent: "flex-end", gap: 12 }}>
                        <button onClick={(e) => { e.stopPropagation(); setShowDatePicker(false); }} style={{ height: 28, padding: "0 12px", background: V.accent, border: "none", borderRadius: 6, color: V.text, fontSize: 12, fontWeight: 600, cursor: "pointer" }}>Save</button>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                  {icons.map(icon => (
                    <button key={icon.id} onClick={() => setSelectedIcon(icon.id)} style={{ width: 40, height: 40, borderRadius: 10, background: V.bg, border: `1px solid ${selectedIcon === icon.id ? V.accent : V.border}`, display: "flex", alignItems: "center", justifyContent: "center", color: selectedIcon === icon.id ? V.accent : V.textTertiary, cursor: "pointer", transition: "all .2s" }}>{icon.svg}</button>
                  ))}
                </div>
              </div>
              ...
              <div style={{ marginBottom: 32 }}>
                ...
                <textarea 
                  ...
                  style={{ width: "100%", minHeight: 100, padding: "14px", background: V.bg, border: `1px solid ${V.border}`, borderRadius: 10, color: V.text, fontSize: 14, outline: "none", resize: "none" }}
                />
              </div>

              <div style={{ marginBottom: 32 }}>
                <label style={{ display: "block", fontSize: 13, fontWeight: 600, color: V.text, marginBottom: 16 }}>How will you measure progress? *</label>
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  {[
                    ...
                    <label key={opt.id} style={{ display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }}>
                      <div onClick={() => setProgress(opt.id)} style={{ width: 18, height: 18, borderRadius: "50%", border: `2px solid ${progress === opt.id ? V.accent : V.border}`, background: progress === opt.id ? V.accent : "transparent", display: "flex", alignItems: "center", justifyContent: "center" }}>{progress === opt.id && <div style={{ width: 6, height: 6, borderRadius: "50%", background: V.bg }} />}</div>
                      <span style={{ fontSize: 14, color: progress === opt.id ? V.text : V.textSecondary, fontWeight: 500 }}>{opt.label}</span>
                    </label>
                  ))}
                </div>
            ...
            <div style={{ padding: "0 24px 24px" }}>
              {mode === 'goal' ? (
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    {files.map((file, i) => (
                      <div key={i} style={{ 
                        ...
                        <div style={{ 
                          width: 40, height: 40, borderRadius: 8, background: V.bg, 
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          {file.progress < 100 && (
                            <div style={{ width: "100%", height: 3, background: V.border, borderRadius: 2, marginTop: 8, overflow: "hidden" }}>
                ...
                <>
                  ...
                  <div style={{ border: `1px solid ${V.border}`, borderRadius: 12, padding: 32, textAlign: "center", color: V.textTertiary, fontSize: 14, background: V.bg }}>
        ...
        <div style={{ padding: "16px 24px", display: "flex", gap: 12, background: V.bg, borderTop: `1px solid ${V.border}` }}>
          <button onClick={handleBack} style={{ flex: 1, height: 44, background: V.bg, border: `1px solid ${V.border}`, borderRadius: 10, color: V.text, fontSize: 14, fontWeight: 600, cursor: "pointer" }}>{step === 1 ? "Cancel" : "Back"}</button>
          <button 
            onClick={handleNext}
            disabled={(step === 1 && !isNextEnabled)}
            style={{ flex: 2, height: 44, background: (mode === 'goal' && step === 2) ? V.text : (step === 3) ? V.text : (step === 1 && !isNextEnabled) ? "var(--gh-border)" : V.accent, border: "none", borderRadius: 10, color: (mode === 'goal' && step === 2) ? V.bg : (step === 3) ? V.bg : (step === 1 && !isNextEnabled) ? "var(--gh-text-secondary)" : "var(--gh-bg)", fontSize: 14, fontWeight: 700, cursor: (step === 3 || (mode === 'goal' && step === 2) || (step === 1 && isNextEnabled)) ? "pointer" : "not-allowed", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, transition: "all .3s ease" }}
          >
